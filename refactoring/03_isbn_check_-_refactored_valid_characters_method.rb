...
# Method to filter number if x is anywhere but the last character
def is_x_bad?(isbn)
  first_nine = isbn.split("")[0..-2]  # create an array from first nine characters in isbn number
...
# Bad ISBN numbers
puts is_too_small?("4780470059029")
puts is_too_small?("0-321@14653-0")
puts is_too_small?("877195x869")
puts is_too_small?("")
puts is_too_small?(" ")
puts is_too_small?("-")